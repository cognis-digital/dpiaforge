"""Native cognis-connect emit for dpiaforge — forward findings to any platform.

Maps dpiaforge's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    dpiaforge ... --format json | dpiaforge-emit --to stix
    dpiaforge-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
