"""DPIAFORGE core — DPIA and EU AI Act impact-assessment generator."""
...
RULES = [
    ("DPI-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("DPI-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("DPI-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
