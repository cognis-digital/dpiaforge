#!/usr/bin/env sh
# Universal installer for dpiaforge. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dpiaforge.git"
echo "Installing dpiaforge ..."
